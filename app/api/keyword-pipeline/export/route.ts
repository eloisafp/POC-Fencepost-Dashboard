...
// Phase 5 — builds the multi-tab Excel workbook and streams it back as a direct
// file download (Content-Disposition: attachment). No Google Sheets, no OAuth.
...
export async function GET(req: NextRequest) {
  ...
  return new Response(buffer, {
    headers: {
      ...
      'Content-Disposition': `attachment; filename="${run.client_slug}-keywords-content-calendar.xlsx"`,
    },
  })
}
